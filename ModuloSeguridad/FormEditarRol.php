...
class FormEditarRol
{
    public function formEditarRolShow(
        $rol,
        $listaRolPrivilegios,
        $listaPrivilegios
    )
...
<body>
    <main>
        ...
        <section id="main">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="PostEditarRol.php" method="POST">
                                        ...
                                        <td>
                                            <input type="checkbox"
                                                name="privilegio-<?php echo $privilegio["id_privilegio"] ?>" <?php 
                                                    foreach ($listaRolPrivilegios as $rolPrivilegio) {
                                                        if ($rolPrivilegio["id_privilegio"] == $privilegio["id_privilegio"]) {
                                                            echo "checked";
                                                        }
                                                    }
                                                ?>>
