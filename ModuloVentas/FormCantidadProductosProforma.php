...
class FormCantidadProductosProforma
{
    public function formCantidadProductosProformaShow($producto)
    {
        ?>
...
<head>
    ...
    <title>Cantidad Productos Proforma</title>
...
<body style="background-color: #98c0e3;">
    <div class="container">
        <div class="card w-50 shadow-sm bg-body rounded" style="margin: 5rem auto">
            ...
            <form action="PostAgregarProductoProforma.php" method="POST">
                <div class="card-body">
